...
import br.gov.rj.fazenda.email.corp.image.generators.BarbecueBarcodeGenerator;
import br.gov.rj.fazenda.email.corp.image.generators.Barcode4jBarcodeGenerator;
import br.gov.rj.fazenda.email.corp.image.generators.QRGenBarcodeGenerator;
import br.gov.rj.fazenda.email.corp.image.generators.ZxingBarcodeGenerator;

@RestController
@RequestMapping("api/barcodes")
public class BarcodesResource {
    ...
    @PostMapping(value = "/barbecue/2of5", produces = MediaType.IMAGE_PNG_VALUE)
    public ResponseEntity<BufferedImage>  barbecue2of5Barcode(@RequestBody String barcode) throws Exception {
        return okResponse(BarbecueBarcodeGenerator.generate2of5BarcodeImage(barcode));
    }
    ...
    @PostMapping(value = "/zxing/2of5", produces = MediaType.IMAGE_PNG_VALUE)
